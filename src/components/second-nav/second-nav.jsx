...
class SecondNav extends Component {
    constructor(props) {
        ...
        this.meetingNav = [{ name: '全部', key: 'all' }, { name: '项目汇报', key: 'prj' }, { name: '技术交流', key: 'tech' }, { name: '会议纪要', key: 'meet-record' }]
        this.fileNav = [{ name: '服务器', key: 'server' }, { name: '产品', key: 'product' }, { name: '客户端', key: 'client' }, { name: '硬件', key: 'hardware' }]
        ...
        return (
            <ul className='second-nav'>
                <Switch>
                    ...
                    <Route path='/meeting'>
                        {
                            this.meetingNav.map((item, index) => {
                                return (
                                    <li
                                        onClick={() => {
                                            this.setState({
