        ...
        return (
            <div>
                <div id="personmessage_bg">
                    <div id="personmessage_header">
                        <a href="/" className="personmessage_header_a personmessage_header_a3">个人主页</a>
                        <a href="/pages/Pubilcblog" className="personmessage_header_a">博客</a>
                        <a className="personmessage_header_a">资料共享</a>
                        <a className="personmessage_header_a">成果展示</a>
                        <div className="personmessage_header_loge"
                            style={{
                                backgroundImage: 'url(' + this.state.userimg + ')'
                            }}
                        ></div>
                        <p>{this.state.username}</p>
                        <a className="personmessage_header_a2 personmessage_header_a">退出</a>
                    </div>
