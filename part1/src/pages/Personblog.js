        ...
        return (
            <div>
                <div id="personblog_bg">
                    <div id="personblog_header">
                        <a href="/" className="personblog_header_a personblog_header_a3">个人主页</a>
                        <a href="/pages/Pubilcblog" className="personblog_header_a">博客</a>
                        <a className="personblog_header_a">资料共享</a>
                        <a className="personblog_header_a">成果展示</a>
                        <div className="personblog_header_loge"
                            style={{
                                backgroundImage: 'url(' + this.state.userimg + ')'
                            }}
                        ></div>
                        <p>{this.state.username}</p>
                        <a className="personblog_header_a2 personblog_header_a">退出</a>
                    </div>
