        ...
        return (
            <div>
                <div id="pubilcidea_bg">
                    <div id="pubilcidea_header">
                        <a href="/" className="pubilcidea_header_a pubilcidea_header_a3">个人主页</a>
                        <a href="/pages/Pubilcblog" className="pubilcidea_header_a pubilcidea_header_a1">博客</a>
                        <a className="pubilcidea_header_a">资料共享</a>
                        <a className="pubilcidea_header_a">成果展示</a>
                        <div className="pubilcidea_header_loge"></div>
                        <p>张三</p>
                        <a className="pubilcidea_header_a2 pubilcidea_header_a">退出</a>
                    </div>
