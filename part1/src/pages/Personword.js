        ...
        return (
            <div>
                <div id="personword_bg">
                    <div id="personword_header">
                        <a href="/" className="personword_header_a personword_header_a3">个人主页</a>
                        <a href="/pages/Pubilcblog" className="personword_header_a personword_header_a1">博客</a>
                        <a className="personword_header_a">资料共享</a>
                        <a className="personword_header_a">成果展示</a>
                        <div className="personword_header_loge"></div>
                        <p>张三</p>
                        <a className="personword_header_a2 personword_header_a">退出</a>
                    </div>
